          ...
          child: Row(
            ...
            children: [
              ...
              if (e.executionId != null)
                SizedBox(
                  width: 60,
                  child: Text('#${e.executionId}', style: mono),
                ),
              if (e.elapsedMicros != null)
                SizedBox(
                  width: 80,
                  child: Text(_ms(e.elapsedMicros!), style: mono),
                ),
              Expanded(
                child: Text(
                  e.kind == 'state_emission'
        ...
        return Padding(
          ...
          child: Row(
            children: [
              SizedBox(
                width: 60,
                child: Text('#${s.executionId}', style: mono),
              ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (b.lastGroups != null)
                  Text('rebuilt groups: ${b.lastGroups}', style: mono),
                if (b.lastEvent != null)
                  Text(
                    'last event: ${b.lastEvent} (${b.lastStatus})',
                    style: mono,
                  ),
                if (b.lastState != null)
                  Text(
            ...
            child: Column(
              ...
              children: [
                ...
                if (e.data['error'] != null)
                  Text('${e.data['error']}', style: mono, maxLines: 3),
